...
{ 
    ...
    public String checkAccount(String iuser, String ipassword) throws RemoteException
    {
      	// Local declarations

        Connection conn = null;		                 // connection to the orderinfo database
        Statement stmt = null;		                 // A Statement object is an interface that represents a SQL statement.
        String ReturnString = "Account is valid";	 // Return string. If everything works you get an 'OK' message
        ...
        try
        {
            ...
            String sql = "SELECT COUNT(*) FROM USERS WHERE user_name = \""+iuser+"\" AND password = \""+ipassword+"\"";
            // execute the update
            ...
            //+----------+
            //|        1 |
            //+----------+. stmt returns an instance  
            ResultSet rs = stmt.executeQuery(sql);
            rs.next();
            int count = rs.getInt("COUNT(*)");
            if(count == 0){
                ReturnString = "Account is invalid";
            } 
