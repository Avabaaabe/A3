...
public class SignUpServices extends UnicastRemoteObject implements SignUpServicesAI
{ 
    ...
    public SignUpServices() throws RemoteException {}
    ...
    public String newAccount(String idate, String iuser, String ipassword) throws RemoteException
    {
      	// Local declarations

        Connection conn = null;		                 // connection to the orderinfo database
        Statement stmt = null;		                 // A Statement object is an interface that represents a SQL statement.
        String ReturnString = "Account Created";	     // Return string. If everything works you get an 'OK' message
        ...
        try
        {
            ...
            String sql = "INSERT INTO USERS(user_date, user_name, password) VALUES (\""+idate+"\",\""+iuser+"\",\""+ipassword+"\")";
            
            // CREATE TABLE users (user_date DATE, user_name VARCHAR(20), password VARCHAR(20));
